const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: 'Welcome to my blog', url: 'https://ruoyaochen2002.pp.ua/' },
    { title: 'If you wanna know more about me...', url: 'https://ruoyaochen2002.pp.ua/Knowledge&Action/usermanual_working' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: 'Share my projects',
  ...
  HEO_HERO_CATEGORY_2: { title: 'User Manual', url: '/tag/User Manual' },
  HEO_HERO_CATEGORY_3: { title: 'Thoughts', url: '/tag/Thoughts' },
