const CONFIG = {
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: 'Love',
  HEO_HERO_TITLE_2: 'Enthusiasm',
  ...
  HEO_HERO_CATEGORY_2: { title: 'Recommended', url: '/tag/Recommended' },
  HEO_HERO_CATEGORY_3: { title: 'Informal Essay', url: '/tag/Informal Essay' },
  ...
  HEO_INFOCARD_GREETINGS: [
    'Hi! I am',
    '🔍 Passionate about sharing and eager to help',
    '🤝 Expert in interaction and communication',
    '🏃 Grounded and action-oriented',
    '🏠 Creative writer and filmmaker',
    '🤖️ Enthusiast of digital technology',
    '🧱 The driving force of any team'
  ],
  ...
  HEO_INFO_CARD_URL3: 'https://ruoyaochen2002.pp.ua/Knowledge&Action/usermunual_life',
