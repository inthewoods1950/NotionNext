...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'A young professional focusing on product management.', // 作者简介
  ...
  GREETING_WORDS:
    ...
    'This website is my user manual. You can choose different modules based on your needs. Enjoy your reading!',
