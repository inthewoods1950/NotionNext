...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi, this is Ruoyao CHEN. And this website is my user manual.You can choose different modules based on your needs. Enjoy your reading! PC recommended.🎉',
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'www.linkedin.com/in/ruoyaochen/', // 你的linkedIn 首页
